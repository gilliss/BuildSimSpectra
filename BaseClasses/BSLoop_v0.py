...
class BSLoop():
    ...
    def For(self, objType = None, comboRule = None, **recur):
        """
        ...
        comboRule = info for weighting hist in a combination
        recur = a dict of args for the next layer of recursion
        """
        if recur:
            r_objType = recur['r_objType']
            r_comboRule = recur['r_comboRule']
            r_recur = recur['r_recur']
            #print('recur args:',r_objType, r_comboRule, r_recur)
        ...
        if(objType == 'detector'):
            for obj in bscfg.GetDetectorList():
                ...
                if recur:
                    self.For(objType = r_objType, comboRule = r_comboRule, **r_recur)
    ...
    #         r_comboRule = recur['r_comboRule']
    #         r_recur = recur['r_recur']
    #         print(r_objType, r_comboRule, r_recur)
    ...
    #         for obj in bscfg.GetDetectorList():
    #             print('detector', obj)
    #             #Recur(objType = recur_arg_dict['objType'], comboRule = recur_arg_dict['comboRule'], Recur = recur_arg_dict['Recur'])
